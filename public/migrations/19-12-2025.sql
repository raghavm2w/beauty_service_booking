...
CREATE TABLE
    services (
        ...
        CONSTRAINT fk_service_subcategory FOREIGN KEY (subcategory_id) REFERENCES subcategories (id)
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE
    service_availability (
        ...
        updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        INDEX (provider_id),
        CONSTRAINT fk_availability_service FOREIGN KEY (service_id) REFERENCES service (id) ON DELETE CASCADE
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
