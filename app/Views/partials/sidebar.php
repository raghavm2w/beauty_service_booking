    ...
    <div class="app">
        ...
        <aside class="sidebar">
            ...
            <nav class="menu">
                ...
                <a class="<?= str_contains($currentPage, 'services') ? 'active' : '' ?> " href="/admin/services">My
                    Services</a>
                <a class="<?= str_contains($currentPage, 'avail') ? 'active' : '' ?> "
                    href="/admin/avail">Availability</a>
                <a class="<?= str_contains($currentPage, 'bookings') ? 'active' : '' ?> "
                    href="/admin/bookings">Bookings</a>
                <a class="<?= str_contains($currentPage, 'settings') ? 'active' : '' ?> " href="#"
